...
**Date:** 2026-09-12 · **Base:** `main` (planning verified at `3a288d3d`; re-verify anchors on the tree you branch from) · **Tracking:** DMNC-1500 umbrella; DMNC-1501 / 1503 re-scoped below; DMNC-1502 (COB) deferred · **Controller:** Fable, fresh session, in `/Users/doke/extracode/DOSBTS` on `main`.
